...
public void setup() {
  ...
  colors[0] = color(0xFF9900);
  colors[1] = color(100, 200, 0);
  colors[2] = color(0xFFFF00);
  colors[3] = color(200);
  colors[4] = color(150);
  colors[5] = color(100);
  colors[6] = color(0x0000FF);
  colors[7] = color(0, 0, 100);
  colors[8] = color(0x00FFFF);
  colors[9] = color(0xFF00FF);
...
public static final int WIDTH = 900, HEIGHT = 500;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "enVoiture" };
    if (passedArgs != null) {
