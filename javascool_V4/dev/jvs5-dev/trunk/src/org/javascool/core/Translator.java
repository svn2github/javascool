...
public class Translator {
     ...
     */
    public static int[] scanConstruct(String string, int offset, String start, String stop, String escape, boolean recurse,
	    boolean code) {
	int index[] = { -1, offset };
	if (0 <= offset && offset < string.length() && stop != null) {
	    ...
	    for (index[1] = index[0] + (start == null ? 0 : start.length()); index[1] < string.length()
