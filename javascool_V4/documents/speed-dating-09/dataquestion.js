//
// Fichier des contenus du speed-dating de la science
//

var under_teufels_mails = 'p.aigouy@vsp.fr,tessier@unice.fr,laurence.grammare@eurecom.fr,meste@i3s.unice.fr,thierry.vieville@sophia.inria.fr';
...

{
  ...
  'answers':new Array(
    'Oui, il reste de belles ressources naturelles en eau et c\'est son exploration par des robots souterrains qui va permettre de l\'exploiter raisonnablement',
    'Oui, il reste de belles ressources naturelles en eau et c\'est son exploration par des scientifiques qui va permettre de l\'exploiter raisonnablement', 
    'Non, hélas il ne reste plus de rivières souterraines à explorer tout est connu à ce jour au niveau du sous-sol de la région', 
  ...
  
{
  ...
  'answers':new Array(
    'Trouver comment les faire marcher en rang, de manière différente chaque jour, utilise les mêmes mathématiques que pour optimiser les réseaux informatiques',
    'Ce sont les écolières qui utilisent le plus de mathématiques pour faire leur devoir sur internet, ce qui crée un problème de société inédit', 
    'On appelle écolière un réseau internet expérimental où tous les ordinateurs discutent sans cesse avec tous les autres', 
...

{
  ...
  'answers':new Array(
    'Il n\'y aura plus de défibrilateur cardiaque dans un proche futur, car on vient de montrer que l\'objet peut-être dangereux, donc à proscrire par principe de précaution',
    'Il n\'y aura plus de défibrilateur cardiaque dans un proche futur, car les maladies cardiaques sont amenées à disparaître, avec les progrès médicaux', 
...

{
  ...
  'answers':new Array(
    'Infaisable dans l\'état actuel de nos connaissances, et neurophysiologues et informaticiens ont prouvé cette impossibilité',
    'On peut tout simplement mesurer l\'activité cérébrale et utiliser ce signal comme interface avec un logiciel', 
    'C\'est possible, mais extrêmement dangereux pour la santé physique et mentale du sujet', 
...

{
  ...
  'answers':new Array(
    'Oui des anti-corps thérapeuthiques, des protéïnes naturelles facilement acceptées par l\'organisme, neutralisent aussi des virus et même des tumeurs (immunisation passive).',
    'Non, seule la vaccination active, en injectant le virus dénaturé développé sur un animal, permet à l\'organisme de développer ces propres anti-corps', 
    'Oui avec des antibiotiques qui détruisent à la fois les virus et les microbes, donc rendent bénignes l\'attaque de l\'organisme par un virus', 
...

{
  ...
  'answers':new Array(
    'A partager de manìere sûre, avec des personnes reconnues de confiance, nos données',
    'A sauvegarder et enlever d\'internet toutes nos informations personnelles qui sont par erreur sur des sites publics',
    'A rien ! C\'est une erreur terminologique, FACEbook existe, pas SAFEbook',
...

{
  ...
  'answers':new Array(
    'Deux: électroniciens et informaticiens',
    'Cinq: physiciens, électroniciens, informaticiens, mathématiciens et médecins', 
    'Onze: dans trois domaines de la physique et quatre des mathématiques et quatre de l\'informatique', 
...

{
  ...
  'answers':new Array(
    'Rien, la preuve: on reconnait très bien un visage avec un seul oeil !',
    'Le modèle 3D permet de reconnaître le visage sous différents points de vue et d\'éviter les déformations liées à la projection 3D -> 2D',
    'Rien, un modèle 3D est plus complexe qu\'un modèle 2D, donc moins stable numériquement et plus sujet à des erreurs de reconstruction', 
...

{
  ...
  'answers':new Array(
    'Pour les urbanistes du futur, il s\'agit de modéliser l\'intrusion de l\'eau dans les rues pour laisser passer l\'eau et faciliter son infiltration',
    'Aucune solution: il faut assumer les erreurs du passé et déplacer les implantations urbaines vers des lieux non exposés', 
    'C\'est un défi pour le génie civil: la construction de digues de plus en plus élevées constituera des ouvrages millénaires comme les pyramides égyptiennes', 
...
{
  'prenom':'Raymond et David',
  'nom':'Knopp et Gesbert',
  ...
  'answers':new Array(
    'Le fait qu\'utiliser un réseau «ad-hoc» puisse provoquer des catastrophes à grande échelle sur l\'internet, comme une pandémie virale sans limite',
    'Lors d\'une catastrophe, c\'est grâce à un réseau d\'objets communicants que les secours peuvent déployer leur communication dans un milieu dégradé', 
    'Lors d\'une catastrophe, il faut arrêter toutes les communications sans fil et «ad-hoc», pour permettre aux secours d\'utiliser le réseau standard sans encombre', 
...

{
  ...
  'answers':new Array(
    'Pour rien ! C\'est l\'informatique et non les mathématiques que la médecine utilise aujourd\'hui',
    'Pour expérimenter sur le cerveau des mathématiciens: le relief cérébral se modifie au fil du temps, lorsque l\'on calcule toute la journée',
    'Pour créer, avec les informaticiens, des algorithmes d\'analyse d\'images biologiques',
...

{
  ...
  'answers':new Array(
    'Non: le rayonnement lié à la multplication des calculs au niveau des processeurs serait dangeureux pour la santé',
    'Oui: cela permettra au stylo d\'écrire de manière autonome et à l\'interrupteur d\'être complétement automatique', 
