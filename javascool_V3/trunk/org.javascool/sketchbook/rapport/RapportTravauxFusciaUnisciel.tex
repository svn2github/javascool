...
\begin{itemize}
\item INRIA/Fuscia: C\'{e}cile Picard-Limpens  et Thierry Vieville
...
%%Les sciences informatiques jouent aujourd’hui un rôle essentiel pour notre économie et notre société. Il est important de les rendre compréhensibles. L’INRIA a mis en place une offre de contenus culturels et pédagogiques à destination de tous les curieux de sciences, mais aussi des élèves et des enseignants. Son objectif ? diffuser et permettre la compréhension et l'appropriation par tous des sciences informatiques. D'où son rôle actif dans des manifestations telles que la fête de la science.

%Dans son souci de permettre la compr\'{e}hension et l'appropriation par tous des sciences informatiques, l'INRIA s'investit activement dans la F\^{e}te de la science. \`{A} cette occasion, je suis intervenue \`{a} plusieurs reprises et dans diff\'{e}rents  \'{e}tablissements, à Grenoble (38) et Sophia-Antipolis (06), pour introduire le m\'{e}tier de chercheur mais \'{e}galement mon domaine, la synth\`{e}se sonore. L'objectif principal de cette manifestation est de susciter des vocations, un enjeu primordial aujourd'hui o\`{u} les fili\`{e}res scientifiques sont d\'{e}laiss\'{e}es par les \'{e}tudiants. J'ai t\^{a}ch\'{e} dans ce cadre de montrer la richesse des activit\'{e}s entreprises, la pluralit\'{e} des m\'{e}tiers existants dans le domaine, et l'int\'{e}r\^{e}t d'un tel m\'{e}tier dans la soci\'{e}t\'{e}, qui plus est dans un monde du tout technologique. 
