 ...
 * @serial exclude
 */
public class TortueLogo implements org.javascool.Proglet {
  private TortueLogo() {}
  ...
  public static void home() {
    update(panel.width / 2, panel.height / 2);
  }
  ...
  public static void set_background(int n) {
    panel.setBackground(colors[n < 0 || n > 9 ? 0 : n]);
  }
