...
public class Pml {
  ...
  private final void setParent(Pml value) {
    if(parent == null)
      parent = value;
  }
  ...
  public final double getDecimal(String name, double value) {
    try { return Double.parseDouble(getString(name, "0"));
  ...
  public final int getInteger(String name, int value) {
    try { return Integer.parseInt(getString(name, "0"));
    } catch(NumberFormatException e) {
      return value;
    }
  }
