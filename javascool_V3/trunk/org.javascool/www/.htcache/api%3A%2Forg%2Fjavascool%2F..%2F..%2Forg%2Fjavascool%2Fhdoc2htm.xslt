...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:import href="?page=api:/org/javascool/./hml2htm.xslt"/>
...
<xsl:template match="l">
  <xsl:choose>
    ...
    <xsl:when test="@class = 'note'"><sup><a href="?page=api:/org/javascool/{concat('#', @link)}"><xsl:value-of select="@link"/></a></sup></xsl:when>
