...
%%%%% pour avoir 4 transparents par page, de'commenter les deux lignes
%%%%% suivantes
%\usepackage{2up}
%\twoup

\usepackage{oldlfont,amssymb,epsf,stmaryrd,epsfig}
\usepackage{fullpage,amssymb,amsmath,latexsym,alltt}
\usepackage{epsf,sem-a4,semrot}
\usepackage{semcolor,semhelv}
\usepackage{pstricks,pst-node,pst-plot,multido}
\usepackage{epsfig}
\usepackage{pstricks}
\usepackage{semcolor}
...
%%%%% pour forcer l'utilisation de \begin{note} ... \end{note}
\noxcomment
