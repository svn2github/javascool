 ...
 */
public class SourceEditorC extends JApplet implements KeyListener{
  private static final long serialVersionUID = 1L;

  /** Used to run as a standalone program. */
  public static void main(String usage[]) { 
    SourceEditorC applet = new SourceEditorC();
    javax.swing.JFrame f = new javax.swing.JFrame(); f.getContentPane().add(applet); applet.init(); f.pack(); 
    f.setSize(400, 700);
    f.setVisible(true); 
  }
  ...
  // Widget construction
  private Editor pane; private JLabel line; private int iline = 0; private JMenuBar bar;
  {
    // Builds the widget
  ...
  public void caretUpdate(CaretEvent e) {
    ...
    //  int l = 1 + pane.getLineOfOffset(e.getDot());
        ...
        StyledDocument stDoc = (StyledDocument)pane.getDocument();
        int l = stDoc.getRootElements()[0].getElementIndex(position) + 1;
