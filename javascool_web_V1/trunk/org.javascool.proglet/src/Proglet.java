 ...
 *  <li><tt>static JPanel panel;</tt> which is the static instantiation of the proglet's swing panel.</li>
...
public class Proglet {
  ...
  public static void main(String usage[]) { 
    ...
    try { Class.forName(usage[0]).getMethod("test").invoke(null); } catch(Exception err) { System.err.println(err); }
  }
  ...
  public static class Test extends JApplet { 
	...
	try { Class.forName(getParameter("proglet")).getMethod("test").invoke(null); } catch(Exception err) { System.err.println(err); }
      }});
